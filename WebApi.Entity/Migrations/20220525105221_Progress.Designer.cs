...
namespace WebApi.Entity.Migrations
{
    ...
    [Migration("20220525105221_Progress")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi.Entity.Models.Progress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebApi.Entity.Models.Progress", b =>
                {
                    b.HasOne("WebApi.Entity.Models.User", "User")
                        .WithOne("Progress")
                        .HasForeignKey("WebApi.Entity.Models.Progress", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
